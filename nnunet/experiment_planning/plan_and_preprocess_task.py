...
def create_lists_from_splitted_dataset(base_folder_splitted):
    """ 根据data.json来获取已经拆解了的列表，返回[ [000.nii.gz, 001.nii.gz...label.nii.gz] ]和{0：模态}的字典。"""
    lists = []
