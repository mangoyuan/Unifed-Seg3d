...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.print_to_log_file(f'base_lr: {self.initial_lr}, min_lr: {self.min_lr}, max_epoch: {self.max_num_epochs}, '
                               f'train_ipb: {self.num_batches_per_epoch}, val_ipb: {self.num_val_batches_per_epoch}')
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            ...
            self.print_to_log_file("TRAINING KEYS(%s):\n %s" %
                                   (len(self.dataset_tr.keys()), str(self.dataset_tr.keys())),
    ...
    def initialize_network_optimizer_and_scheduler(self):
        ...
        :return:
        """
        # print(self.net_conv_kernel_sizes, self.net_num_pool_op_kernel_sizes)
        ...
        base_num_features = 16  # self.base_num_features
        self.print_to_log_file(f'base_num_features: {base_num_features}')
        self.network = Generic_UNet(self.num_input_channels, base_num_features, self.num_classes, net_numpool,
